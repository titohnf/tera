...
export default function TutorClassFilters({ q, level, type, status, scope, availableLevels }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {hasFilter && (
        <Link href="/tutor/classes" className="px-3 py-2 text-sm font-medium text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors whitespace-nowrap">
          Reset
        </Link>
      )}
    </div>
