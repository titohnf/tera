  ...
  return (
    <div>
      <button
        ...
        disabled={isPending}
        className="flex items-center justify-center gap-2 w-full px-4 py-2 border border-red-200 text-sm font-medium rounded-lg text-red-600 hover:bg-red-50 transition-colors disabled:opacity-50"
      >
