...
export default function InvoiceForm({ students, classes, classStudents, billingRates, sessionCounts = {}, initialStudentId }: InvoiceFormProps) {
  ...
  // sesi selalu rinci dengan satuan pertemuan. Dulu bentuk (Ringkas/Rinci)
  // dan jenis (Potongan/Koreksi) dua tombol terpisah — yang satu menyebut
  // aksinya, yang lain menyebut keadaannya — dan admin tidak bisa membaca
  // baris mana yang sebenarnya dipilih.
  //
  // Nilai rupiah baris dipertahankan saat berpindah jenis: 4 × Rp120.000 yang
  // diringkas jadi Rp480.000, bukan Rp120.000. Tanpa itu satu ketukan diam-diam
  // mengubah total invoice.
            ...
            <div key={index} className="grid grid-cols-12 gap-2 items-center">
              ...
              <div className="col-span-1 flex flex-col items-center gap-1">
                ...
                {item.is_deduction ? (
                  ...
                  // berwarna adalah yang sedang dipilih. Potongan = diskon atau
                  // kompensasi (ringkas), Koreksi sesi = menyamakan tagihan
                  // dengan kalender (rinci, dihitung di penanda selisih).
