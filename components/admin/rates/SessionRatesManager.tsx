...
export default function SessionRatesManager({ periodId, initialRates }: { periodId: string; initialRates: SessionRate[] }) {
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-gray-50">
                  ...
                  <th className="text-right px-3 py-2.5 text-xs font-medium text-gray-500 w-36">Gaji / Sesi</th>
                </tr>
              </thead>
