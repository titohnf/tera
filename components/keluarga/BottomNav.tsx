 ...
 *
 * "Riwayat" menampung Jadwal Kelas dan Laporan — dua hal yang sudah terjadi;
 * "Profil" menampung Tagihan dan bahan belajar. Karena keduanya menaungi lebih
 * dari satu halaman, yang menyala ditentukan oleh daftar `cocok`, bukan oleh
 * perbandingan persis dengan `href`.
 */
...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    cocok: ['/profil', '/tagihan', '/materi', '/penguasaan'],
    ikon: (
...
export default function BottomNav({ studentId }: { studentId: string }) {
